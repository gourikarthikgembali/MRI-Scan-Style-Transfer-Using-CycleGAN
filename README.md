...
A simple project to translate **MRI T1 images to T2** and **T2 to T1** using a CycleGAN, trained on MRI scan data. The notebook demonstrates both directions with example outputs. 
...
- MRI Scan images data for T1 and T2
